...
from kivyx.uix.behaviors.draggable import ongoing_drags


KV_CODE = '''
#:import create_spacer kivyx.uix.behaviors.draggable._create_spacer

<ReorderableGridLayout@KXDragReorderBehavior+GridLayout>:
...
BoxLayout:
    ...
    BoxLayout:
        ...
        MyButton:
            ...
            on_tap: app.cancel_ongoing_drags()
'''
...
if __name__ == "__main__":
    SampleApp(title="Cancelling ongoing drags").run()
